...
const filePaths = [
    "getAllTopicsSubscriberCount/index.test.js",
    "getSubscriberCount/index.test.js",
    "hasAllTopicsSubscribers/index.test.js",
    "hasSubscribers/index.test.js",
    "publish/index.test.js",
    "publishToAllTopicsOnly/index.test.js",
    "subscribe/index.test.js",
    "unsubscribe/index.test.js",
    "unsubscribeFromAllTopics/index.test.js",
];
async function main() {
    const testContext = {
        process,
