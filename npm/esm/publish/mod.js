...
export default function publish(event, options = {}) {
    ...
    if (topic) {
        ...
        Object.keys(subscribers.once).forEach((t) => Object.keys(subscribers.once[t]).forEach((key) => subscribers.once[t][key](fullEvent)));
        subscribers.once = {};
        Object.keys(subscribers.always).forEach((t) => Object.keys(subscribers.always[t]).forEach((key) => subscribers.always[t][key](fullEvent)));
    }
    return timestamp;
}
